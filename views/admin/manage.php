...
<div id="inner-shortcuts">
	<?php echo anchor('admin/'.$this->module.'/items/add_item_images/'.$id, 'Add Item Images', 'class="btn blue small"'); ?>
</div>
		...
		<table border="0" class="table-list" cellspacing="0">
			...
			<tbody>
				...
				<tr id="item_<?php echo $item->id; ?>">
					...
					<td class="actions">
						<?php echo
						anchor('admin/'.$this->module.'/items/edit/'.$item->id, lang('items:edit'), 'class="button"').' '.
						anchor('admin/'.$this->module.'/items/delete_item_images/'.$item->id, 	lang('items:delete'), array('class'=>'button')); 
						?>
					</td>
				</tr>
				<?php endforeach; ?>
