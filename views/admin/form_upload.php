	...
	<div class="content">
			...
			<div id="fileupload">
			    <form action="upload/do_upload" method="POST" enctype="multipart/form-data">
			    	<input type="hidden" id="csrf_hash_name" name="csrf_hash_name" value="<?php echo $this->security->get_csrf_hash(); ?>" />
			 
			        <div class="fileupload-buttonbar">
			            <label class="fileinput-button btn green">
			                <span>Add files...</span>
		...
		<?php echo form_open_multipart('admin/'.$this->module.'/do_upload', 'class="crud"'); ?>
	
			<div class="form_inputs">
	

		<div class="buttons">
			<?php echo anchor('admin/'.$this->module.'/images/'.$parent, 'Done', array('class' => 'button')); ?>
		...
		jQuery(function () {
		    ...
		    //'use strict';
		        ...
		        url: '<?php echo base_url().'index.php/admin/'.$this->module.'/do_upload'; ?>',
		        dataType: 'json',
		        autoUpload: false,
